...
<html>
    ...
    <body> 
        ...
        <form action="http://localhost:3000/hr/nav/home.php" method="post" style="float:left;">
        ...
        <form action="http://localhost:3000/hr/applicants/display_applicants.php" method="post">
            ...
            <input class="view" type="submit" value="View Applicants">
        </form><br><br>
        <div class="container">
        ...
        <script>
            $("#view").click(function() {
                location.href="http://localhost:3000/hr/applicants/display_applicants.php";
            });
        </script> 
    </body>
</html>